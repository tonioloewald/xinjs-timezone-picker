...
const $7148e8975cd26971$export$6b408984b31c1b30 = [
    ...
    },
    {
        ...
        pin: "291,130",
        offset: 2,
        points: "292,131,293,130,292,128,291,129,292,131",
        abbr: "CAT"
    },
    {
        timezone: "Asia/Oral",
...
const $dac6c3868e5c3497$var$zoneFromRegion = (region)=>{
...
class $dac6c3868e5c3497$export$6e05cc8a7dfe9700 extends (0, $519f1ddd575d759f$export$16fa2f45be04daa8) {
    ...
    get zone() {
        return $dac6c3868e5c3497$var$zoneFromName(this.timezone);
    }
    get region() {
        return (0, $7148e8975cd26971$export$6b408984b31c1b30).find((rg)=>rg.timezone === this.timezone);
    }
    get zoneId() {
        return $dac6c3868e5c3497$var$zoneId(this.zone);
    }
    ...
    hoverRegion = (event)=>{
        ...
        const zone = $dac6c3868e5c3497$var$zoneFromRegion(region);
        zoneName.value = zone !== undefined ? $dac6c3868e5c3497$var$zoneId(zone) : region.timezone;
    };
    pickRegion = (event)=>{
        const { zoneName: zoneName } = this.refs;
        // @ts-expect-error
    ...
    pickZone = (event)=>{
        ...
        const zone = $dac6c3868e5c3497$var$zoneFromId(id);
    ...
    validate() {
        if (this.value !== this.timezone) {
            const newZone = $dac6c3868e5c3497$var$zoneFromName(this.value);
