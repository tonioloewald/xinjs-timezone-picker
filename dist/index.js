...
const $1fe5fe80b15eb088$export$e5df4b513c3da013 = (name)=>{
    return $1fe5fe80b15eb088$export$bc6bb0e72ae9e582.find((tz)=>tz.name === name || tz.shortName === name);
};
const $1fe5fe80b15eb088$export$5726bd0248a82f84 = (tz)=>{
    const name = tz.shortName !== undefined ? tz.shortName : tz.name;
    const { offset: offset } = tz;
    const signedOffset = offset > 0 ? `+${offset}` : offset < 0 ? String(offset) : "";
    return `${name.replace(/_/g, " ")} GMT${signedOffset}`;
};
const $1fe5fe80b15eb088$export$98aa5e92a028d2ff = (id)=>{
    return $1fe5fe80b15eb088$export$bc6bb0e72ae9e582.find((tz)=>id === $1fe5fe80b15eb088$export$5726bd0248a82f84(tz));
};



const $7148e8975cd26971$export$6339e4f5afb1eeb0 = (region)=>{
    let offset = $7148e8975cd26971$export$b04b5cae79e1ad83(region)?.offset;
    if (offset === undefined) offset = region.offset;
    return `${region.timezone.replace(/_/g, " ")} GMT${offset > 0 ? "+" : ""}${offset !== 0 ? offset : ""}`;
};
const $7148e8975cd26971$export$b04b5cae79e1ad83 = (region)=>{
    return (0, $1fe5fe80b15eb088$export$bc6bb0e72ae9e582).find((tz)=>tz.name === region.timezone);
};
...
const $dac6c3868e5c3497$var$timezoneMap = ()=>{
    ...
    svg.append(...(0, $7148e8975cd26971$export$6b408984b31c1b30).map((region)=>{
        ...
        const title = document.createElementNS($dac6c3868e5c3497$var$SVG_XMLNS, "title");
        title.textContent = (0, $7148e8975cd26971$export$6339e4f5afb1eeb0)(region);
...
const $dac6c3868e5c3497$var$timezoneDatalist = $dac6c3868e5c3497$var$datalist({
    id: $dac6c3868e5c3497$var$DATALIST_ID
        ...
        value: (0, $1fe5fe80b15eb088$export$5726bd0248a82f84)(tz)
    })));
class $dac6c3868e5c3497$export$6e05cc8a7dfe9700 extends (0, $519f1ddd575d759f$export$16fa2f45be04daa8) {
    ...
    get zone() {
        return (0, $1fe5fe80b15eb088$export$e5df4b513c3da013)(this.timezone);
    }
    get region() {
        return (0, $7148e8975cd26971$export$6b408984b31c1b30).find((rg)=>rg.timezone === this.timezone);
    }
    get zoneId() {
        return (0, $1fe5fe80b15eb088$export$5726bd0248a82f84)(this.zone);
    }
    ...
    hoverRegion = (event)=>{
        const { zoneName: zoneName } = this.refs;
        // @ts-expect-error
    ...
    pickRegion = (event)=>{
        ...
        const zone = (0, $7148e8975cd26971$export$b04b5cae79e1ad83)(region);
        if (zone !== undefined) {
    ...
    pickZone = (event)=>{
        ...
        const zone = (0, $1fe5fe80b15eb088$export$98aa5e92a028d2ff)(id);
    ...
    connectedCallback() {
        ...
        zoneName.setAttribute("list", $dac6c3868e5c3497$var$DATALIST_ID);
    ...
    validate() {
        if (this.value !== this.timezone) {
            const newZone = (0, $1fe5fe80b15eb088$export$e5df4b513c3da013)(this.value);
            if (newZone === undefined) this.value = this.timezone;
        }
    }
